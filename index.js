...
(function(Exporter) {
	...
	Exporter.getPaginatedTopics = function(start, limit, callback) {
		...
		var query = ''
			...
			+ prefix + 'message_status_values.status_key as _status_key, ' + '\n'
			+ prefix + 'message_status_values.status_text as _status_text, ' + '\n'
			+ prefix + 'message_status_values.status_description as _status_description, ' + '\n'
			+ prefix + 'message_status_values.is_completed as _status_is_completed, ' + '\n'
			+ prefix + 'message_status_values.is_featured as _status_is_featured ' + '\n'
